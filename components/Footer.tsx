            ...
            <div className="col-md-4 col-lg-3 mb-11 mb-lg-0">
              <div className="d-flex flex-column gap-3">
                ...
                <ul className="footer-menu list-unstyled mb-0 d-flex flex-column gap-7">
                  ...
                  <li><a className="link-hover text-body" href="#">Documentation</a></li>
                </ul>
              </div>
            </div>
            <div className="col-md-4 col-lg-2 mb-11 mb-lg-0">
              <div className="d-flex flex-column gap-3">
                ...
                <p className="mb-0">81 Rivington Street London EC2A 3AY</p>
                <a href="mailto:hello@devaspire.agency">hello@devaspire.agency</a>
                <a href="tel:01051923556">0105 192 3556</a>
              </div>
            </div>
          </div>
        </div>
